...
import { Code2, BarChart3, Sparkles, TrendingUp } from "lucide-react";

export default function GitHubActivityOverview() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold mb-4">GitHub Activity Components</h2>
